...
Am 31. Oktober 2008 veröffentlichte eine anonyme Person oder Gruppe namens Satoshi Nakamoto ein Whitepaper mit dem Titel „Bitcoin: Ein Peer-to-Peer-E-Cash-System“. Dieses sich weltweit verändernde Dokument legte den Rahmen für die dezentrale Open-Source-Kryptowährung und die revolutionäre Blockchain-Technologie fest, die dies ermöglicht.

In Abbildung 1.1 im ersten Abschnitt wurde hervorgehoben, wie das Senden von Geld über das traditionelle Bankensystem mehrere Transaktionen, separate Hauptbücher und das Vertrauen in mehr als eine Bank erfordert. Abbildung 1.5 (unten) zeigt, wie Maria Geld an George senden kann, indem sie 10,5 Bitcoin von ihrer Adresse (1BuUygisXY) an eine von George kontrollierte Adresse (1eK5FSywkp) überträgt. In diesem Beispiel wird der Einfachheit halber auf Bitcoin (BTC) verwiesen. Fast alle Kryptowährungen verwenden jedoch diese Art von öffentlichem Hauptbuch und weisen daher die folgenden Vorteile und Probleme auf.  
